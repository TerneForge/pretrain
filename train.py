...
def prepare_data(tokenizer,
    ...
    train_dataset = datasets.load_dataset("semran1/packed_smol", split="train", data_files=data_files)
    ...
    val_dataset = datasets.load_dataset("semran1/packed_smol", split="train", data_dir = "valid")
